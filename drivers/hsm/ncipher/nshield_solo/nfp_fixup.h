...
#define NFP_MODULE_PREAMBLE                                                    \
	...
	MODULE_PARM_DESC(nfp_ifvers,                                           \
			 "maximum interface version (1-2), or any (0)");
...
#define nfp_schedule_timeout(time, timeout) timeout = schedule_timeout(time);

#ifdef MODULE_LICENSE
#define NFP_MODULE_LICENSE MODULE_LICENSE("GPL");
#else
