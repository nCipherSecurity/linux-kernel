...
static int nfp_setup( const struct nfpcmd_dev *cmddev, unsigned char bus, unsigned char slot, unsigned int bar[6], unsigned int irq_line, struct pci_dev *pcidev) {
